...
DATA_ROOT = os.getenv(
    "DATA_ROOT",
    # Anchored to this file's own directory (the pipeline root), NOT the
    # current working directory - so paths resolve correctly whether you
    # run a script from breeze/, breeze/backtest/, or anywhere else.
